        ...
        <form class="form" style="margin-top: 50px;">
            ...
            <div class="inputForm">
                ...
                <input type="password" class="input"
                       placeholder="Nhập mật khẩu của bạn" id="myInput" required>
                <svg viewBox="0 0 576 512" height="1em"
                     xmlns="http://www.w3.org/2000/svg" onclick="myFunction()"><path
            ...
            <div class="flex-row justify-content-center">
                <a href="forgotPassword.jsp" class="span">Quên mật khẩu ?</a>
            </div>

            <button class="button-submit">Đăng Nhập</button>
            <p class="p">Không có tài khoản ? <a href="signup.jsp"><span
